...
class UniteCreatorDialogParamElementor extends UniteCreatorDialogParam{
	...
	protected function putBackgroundParam(){
		...
		?>
			<div class='uc-radioset-wrapper' data-defaultchecked="solid">
		
				Solid:
				<input type="radio" name="background_controls" class="uc-param-checkbox uc-control" data-controlled-selector=".uc-controls-solid" >
				
				Gradient
				<input type="radio" name="background_controls" class="uc-param-checkbox uc-control" data-controlled-selector=".uc-controls-gradient">
			</div>
			
			<div class="uc-controls-solid">
			...
			<div class="uc-controls-gradient">
				<label>Gradient Color</label>
	
				<?php 
				$objOutput->drawSingleSetting("gradient_color1");
				$objOutput->drawSingleSetting("gradient_color2");
				?>
